...
export class AdminController {
   ...
   *
   * @remarks
   * This endpoint can be extended to reload environment variables,
   * refresh caches, or reinitialize feature flags dynamically.
   *
   * @example
   * ```bash
   * curl -X POST -H "x-api-key: super-secret-key" \
   *   http://localhost:7501/admin/reload-config
   * ```
   *
