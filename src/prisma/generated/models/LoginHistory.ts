...
export type LoginHistoryScalarWhereWithAggregatesInput = {
  ...
  country?:
    | Prisma.StringNullableWithAggregatesFilter<'LoginHistory'>
    | string
    | null;
  city?:
    | Prisma.StringNullableWithAggregatesFilter<'LoginHistory'>
    ...
    | null;
  createdAt?:
    | Prisma.DateTimeWithAggregatesFilter<'LoginHistory'>
    | Date
    | string;
};
...
export type LoginHistoryCreateNestedManyWithoutUserInput = {
  ...
  connect?:
    | Prisma.LoginHistoryWhereUniqueInput
    | Prisma.LoginHistoryWhereUniqueInput[];
};
...
export type LoginHistoryUpdateManyWithoutUserNestedInput = {
  ...
  updateMany?:
    ...
    | Prisma.LoginHistoryUpdateManyWithWhereWithoutUserInput[];
  deleteMany?:
    | Prisma.LoginHistoryScalarWhereInput
    | Prisma.LoginHistoryScalarWhereInput[];
};
...
> = runtime.Types.Extensions.GetOmit<
  'id' | 'userId' | 'ip' | 'country' | 'city' | 'createdAt',
  ExtArgs['result']['loginHistory']
>;
...
> = {
   ...
   */
  data:
    | Prisma.LoginHistoryCreateManyInput
    | Prisma.LoginHistoryCreateManyInput[];
  skipDuplicates?: boolean;
};
